        ...
        <template #dropdown>
          <el-dropdown-menu class="drop_menu">
            <el-dropdown-item command="a" v-for="item in itemChild">
              <el-text class="secondTxt" :style="`--my-content: '${item.icon}';`">{{
                item.txt
              }}</el-text>
            </el-dropdown-item>
          </el-dropdown-menu>
